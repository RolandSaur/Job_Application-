...
%---------------------------------------------------------------------------
\setkomavar{subject}{ Applying for Job
}
%---------------------------------------------------------------------------
\opening{
Dear Sir or Madam,
}
 As you can see I can do simple things with bash and zenity. I am really excited about this. Me totally good, please employ me.
\\
Kind regards,\\
Peter Pan
%---------------------------------------------------------------------------
